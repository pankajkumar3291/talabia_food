...
public class TalabiaTextView extends AppCompatTextView {

    public TalabiaTextView(Context context) {
        super ( context );
        init ( context );
    }

    public TalabiaTextView(Context context, AttributeSet attrs) {
        super ( context, attrs );
        init ( context );
    }

    public TalabiaTextView(Context context, AttributeSet attrs, int defStyleAttr) {
